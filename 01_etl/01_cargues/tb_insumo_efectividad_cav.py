...
df_efectividad['EFECTIVIDAD'] = (
    ...
    (df_efectividad['TOTAL_REGISTROS_HOGAR'] + df_efectividad['TOTAL_REGISTROS_MOVIL'] )
) * 100
...
ORDENAR = [ 'MES', 'ANHO', 'KEY', 'CEDULA', 'RETENIDOS_HOGAR', 'NO_RETENIDOS_HOGAR',
       ...
       'TOTAL_REGISTROS_MOVIL', 'EFECTIVIDAD', ]
...
df_efectividad.to_sql(con=database_connection, name='tb_insumo_efectividad_cav', if_exists='append', index=False, chunksize=1000)
print(df_efectividad.head())
print('INSUMO EFECTIVIDAD CAV CREADO')
